...
Contributions are welcome. `go-ruby-abbrev/abbrev` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-abbrev/abbrev`](https://github.com/go-ruby-abbrev/abbrev). This documentation site is in
[`github.com/go-ruby-abbrev/docs`](https://github.com/go-ruby-abbrev/docs). Start from the
